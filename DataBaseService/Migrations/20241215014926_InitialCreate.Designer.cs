...
namespace DataBaseService.Migrations
{
    ...
    [Migration("20241215014926_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServerCore.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ServerCore.Server.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ServerCore.Server.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ServerCore.Server.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ServerCore.Server.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ServerCore.MultiTenancy.Tenant", b =>
                {
                    b.HasOne("ServerCore.Server.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("ServerCore.Server.Users.User", "DeleterUser")
                        .WithMany()
                    ...
                    b.HasOne("ServerCore.Server.Users.User", "LastModifierUser")
                        .WithMany()
