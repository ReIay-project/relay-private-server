...
namespace ServerApp.Servers.MultiTenancy
{
    public class TenantAppService :
        AsyncCrudAppService<Tenant, TenantDto, int, TenantResultRequestDto, CreateTenantDto, TenantDto>,
        ITenantAppService
    {
        ...
        protected override IQueryable<Tenant> CreateFilteredQuery(TenantResultRequestDto input)
        {
