...
{
    [AbpAuthorize(PermissionNames.ManageUsers, PermissionNames.TenantAdmin)]
        ...
        AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        public override async Task<UserDto> CreateAsync(CreateUserDto input)
        {
            ...
            if (input.UserRolesNames != null)
            {
                CheckErrors(await _userManager.SetRolesAsync(user, input.UserRolesNames.ToArray()));
            }
        ...
        protected override UserDto MapToEntityDto(User user)
        {
            ...
            userDto.UserRolesNames = roles.ToList();
